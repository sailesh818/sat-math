...
class Test2Model2Page extends StatefulWidget {
  const Test2Model2Page({super.key});

  @override
  State<Test2Model2Page> createState() => _Test2Model2PageState();
}

class _Test2Model2PageState extends State<Test2Model2Page> {
  ...
  Future<void> _loadQuestions() async {
    final String jsonString = await rootBundle.loadString('assets/test2/test2model2.json');
