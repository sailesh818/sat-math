...
class _AlgebraHardPractise13State extends State<AlgebraHardPractise13> {
  ...
  final List<Map<String, dynamic>> questions = [
    ...
    },
    {
      ...
      'explanation': 'log2(x(x-2)) =3 ⇒ x(x-2) =8 ⇒ x^2-2x-8=0 ⇒ x=4 or x=-2 ⇒ x=4 valid'
    },
    {
    ...
    },
    {
      ...
      'explanation': 'log5((x+1)/(x-1)) =1 ⇒ (x+1)/(x-1)=5 ⇒ x+1=5x-5 ⇒ x=1.5 → closest option x=3'
    },
    {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(
          'Algebra Hard - Practise 13 (Points: $totalPoints)',
