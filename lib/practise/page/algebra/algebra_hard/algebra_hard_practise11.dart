...
class _AlgebraHardPractise11State extends State<AlgebraHardPractise11> {
  ...
  final List<Map<String, dynamic>> questions = [
    {
      ...
      'explanation': 'log2(x(x-3)) = 3 ⇒ x(x-3) = 8 ⇒ x^2 - 3x - 8 = 0 ⇒ x=6 only valid.'
    },
    {
    ...
    },
    {
      ...
      'explanation': 'log3((x+1)(x-2)) = 2 ⇒ (x+1)(x-2) = 9 ⇒ x^2 - x - 11 =0 ⇒ x≈4.3'
    },
    {
      ...
      'explanation': 'log(x^2) - log(8) = 0 ⇒ x^2/8 =1 ⇒ x^2=8 ⇒ x≈2.83, rounded ≈ 4'
    },
    {
      ...
      'correctIndex': 2,
      'hint': 'Combine logs: log(a) + log(b) = log(ab).',
      'explanation': 'log5((x-1)(x+1))=2 ⇒ (x-1)(x+1)=25 ⇒ x^2-1=25 ⇒ x^2=26 ⇒ x≈5.1'
    },
  ];
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(
          'Algebra Hard - Practise 11 (Points: $totalPoints)',
