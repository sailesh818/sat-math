...
class AlgebraHardPractisePage extends StatefulWidget {
  final String jsonFileName;
  final String title;

  const AlgebraHardPractisePage({
    super.key,
  ...
  @override
  State<AlgebraHardPractisePage> createState() =>
      _AlgebraHardPractisePageState();
}

class _AlgebraHardPractisePageState extends State<AlgebraHardPractisePage> {
  ...
  Future<void> loadQuestions() async {
    try {
      final String response = await rootBundle.loadString(
          'assets/algebra/algebrahard/${widget.jsonFileName}');
  ...
  void nextQuestion() async {
    if (currentQuestionIndex < questions.length - 1) {
      ...
      int basePoints = 8 + correctCount; // Hard level scoring
  ...
  void _showRewardedAd({required bool forHint}) {
    ...
    _rewardedAd!.show(onUserEarnedReward: (ad, reward) async {
      if (forHint) {
        ...
        await savePointsToFirebase(8); // Hard level bonus
        ScaffoldMessenger.of(context).showSnackBar(
