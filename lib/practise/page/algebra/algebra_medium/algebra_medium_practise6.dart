...
class _AlgebraMediumPractise6State extends State<AlgebraMediumPractise6> {
  ...
  final List<Map<String, dynamic>> questions = [
    ...
    },
    {
      ...
      'explanation': '-5x + 3 = -2 → -5x = -5 → x = 1'
    },
    {
      'question': '4. Solve: -4x - 6 = -10',
      'options': ['x=1', 'x=-1', 'x=2', 'x=-2'],
      'correctIndex': 2,
      'hint': 'Add 6, then divide by -4.',
      'explanation': '-4x - 6 = -10 → -4x = -4 → x = 1'
    },
    {
      'question': '5. Solve: -x + 7 = 3',
      'options': ['x=4', 'x=-4', 'x=3', 'x=-3'],
      'correctIndex': 0,
      'hint': 'Subtract 7, then multiply by -1.',
      'explanation': '-x + 7 = 3 → -x = -4 → x = 4'
    },
  ];
