...
class _AlgebraMediumPractise5State extends State<AlgebraMediumPractise5> {
  final List<Map<String,dynamic>> _questions = [
    {'question':'1. Solve: 3(x +2) = 12','options':['x=2','x=3','x=4','x=5'],'correctIndex':1},
    {'question':'2. Solve: 4(x -1) +2 = 10','options':['x=2','x=3','x=4','x=5'],'correctIndex':2},
    {'question':'3. Solve: 5(x +3) -4 =16','options':['x=2','x=3','x=4','x=5'],'correctIndex':0},
    {'question':'4. Solve: 2(2x +3) = 14','options':['x=2','x=3','x=4','x=5'],'correctIndex':0},
    {'question':'5. Solve: 3(x -2) +5 = 10','options':['x=3','x=4','x=5','x=2'],'correctIndex':0},
  ];
  ...
  Widget build(BuildContext context){
    return Scaffold(
      ...
      appBar: AppBar(title: const Text('Algebra Medium - Practise 5'), backgroundColor: Colors.green.shade700,centerTitle:true,elevation:3),
      body: SingleChildScrollView(
        padding: const EdgeInsets.all(16),
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children:[
          const Text('Topic: Equations Requiring Distribution', style: TextStyle(fontSize:18,fontWeight:FontWeight.w600,color: Colors.green)),
          const SizedBox(height:8),
          const Text('Expand using distribution, simplify, and solve for x.', style: TextStyle(fontSize:15)),
