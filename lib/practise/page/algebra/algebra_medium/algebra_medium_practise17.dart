...
class AlgebraMediumPractise17 extends StatefulWidget {
  ...
  @override
  State<AlgebraMediumPractise17> createState() => _AlgebraMediumPractise17State();
}

class _AlgebraMediumPractise17State extends State<AlgebraMediumPractise17> {
  final List<Map<String, dynamic>> _questions = [
    {'question': '1. Solve: x/3 + 4 = 7', 'options': ['x=9', 'x=8', 'x=10', 'x=11'], 'correctIndex': 0},
    {'question': '2. Solve: (2x)/5 - 3 = 1', 'options': ['x=10', 'x=8', 'x=9', 'x=7'], 'correctIndex': 0},
    {'question': '3. Solve: (3x)/4 + 2 = 8', 'options': ['x=6', 'x=8', 'x=7', 'x=5'], 'correctIndex': 1},
    {'question': '4. Solve: (5x)/2 - 4 = 6', 'options': ['x=4', 'x=3', 'x=2', 'x=5'], 'correctIndex': 0},
    {'question': '5. Solve: (x/6) + 5 = 9', 'options': ['x=24', 'x=20', 'x=18', 'x=22'], 'correctIndex': 0},
  ];
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            const Text(
              'Topic: Solving for x in Fractions',
              style: TextStyle(fontSize: 18, fontWeight: FontWeight.w600, color: Colors.green),
            ),
            const SizedBox(height: 8),
            const Text(
              'Solve equations where x appears in a fraction.',
