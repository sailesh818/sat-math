...
class AlgebraMediumPractise15 extends StatefulWidget {
  const AlgebraMediumPractise15({super.key});

  @override
  State<AlgebraMediumPractise15> createState() => _AlgebraMediumPractise15State();
}

class _AlgebraMediumPractise15State extends State<AlgebraMediumPractise15> {
  final List<Map<String,dynamic>> _questions = [
    {'question':'1. Solve: 3x + 5 < 14', 'options':['x<3','x<4','x<5','x<2'],'correctIndex':0},
    {'question':'2. Solve: 2x - 7 ≥ 9', 'options':['x≥6','x≥8','x≥5','x≥7'],'correctIndex':3},
    {'question':'3. Solve: 5x + 2 ≤ 17', 'options':['x≤3','x≤4','x≤5','x≤2'],'correctIndex':1},
    {'question':'4. Solve: 4x - 3 > 9', 'options':['x>3','x>2','x>4','x>5'],'correctIndex':0},
    {'question':'5. Solve: 6x + 1 ≤ 19', 'options':['x≤2','x≤3','x≤4','x≤5'],'correctIndex':2},
  ];
  ...
  Widget build(BuildContext context){
    return Scaffold(
      ...
      appBar: AppBar(title: const Text('Algebra Medium - Practise 15'), backgroundColor: Colors.green.shade700, centerTitle:true, elevation:3),
      body: SingleChildScrollView(
        padding: const EdgeInsets.all(16),
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children:[
          const Text('Topic: Simple Inequalities', style: TextStyle(fontSize:18,fontWeight:FontWeight.w600,color: Colors.green)),
          const SizedBox(height:8),
          const Text('Solve simple inequalities and represent the solution.', style: TextStyle(fontSize:15)),
