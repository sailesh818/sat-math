...
class AlgebraMediumPractisePage extends StatefulWidget {
  final String jsonFileName;
  final String title;

  const AlgebraMediumPractisePage({
    super.key,
  ...
  @override
  State<AlgebraMediumPractisePage> createState() =>
      _AlgebraMediumPractisePageState();
}

class _AlgebraMediumPractisePageState extends State<AlgebraMediumPractisePage> {
  ...
  Future<void> loadQuestions() async {
    try {
      final String response = await rootBundle.loadString(
          'assets/algebra/algebramedium/${widget.jsonFileName}');
  ...
  void nextQuestion() async {
    if (currentQuestionIndex < questions.length - 1) {
      ...
      int base = 6 + correctCount; // Medium level scoring
  ...
  Future<void> _useHint() async {
    ...
    if (totalPoints >= 3) {
      await savePointsToFirebase(-3); // cost for hint
      hintPenalty += 3;
