...
class _AlgebraMediumPractise8State extends State<AlgebraMediumPractise8> {
  final List<Map<String,dynamic>> _questions = [
    {'question':'1. Solve: x/3 + 2 = x/4 + 3','options':['x=12','x=4','x=7','x=6'],'correctIndex':3},
    {'question':'2. Solve: 2x/5 -1 = x/2 +1','options':['x=10','x=12','x=6','x=8'],'correctIndex':3},
    {'question':'3. Solve: x/6 +3 = x/3 +1','options':['x=6','x=12','x=9','x=15'],'correctIndex':1},
    {'question':'4. Solve: 3x/4 -2 = x/2 +1','options':['x=8','x=6','x=4','x=2'],'correctIndex':0},
    {'question':'5. Solve: x/5 + 2 = 3x/10 +1','options':['x=5','x=6','x=4','x=3'],'correctIndex':1},
  ];
  ...
  Widget build(BuildContext context){
    return Scaffold(
      ...
      appBar: AppBar(title: const Text('Algebra Medium - Practise 8'), backgroundColor: Colors.green.shade700, centerTitle:true, elevation:3),
      body: SingleChildScrollView(
        padding: const EdgeInsets.all(16),
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children:[
          const Text('Topic: Equations with Fractions on Both Sides', style: TextStyle(fontSize:18,fontWeight:FontWeight.w600,color: Colors.green)),
          const SizedBox(height:8),
          const Text('Solve equations with fractions on both sides.', style: TextStyle(fontSize:15)),
