...
class AlgebraMediumPractise16 extends StatefulWidget {
  ...
  @override
  State<AlgebraMediumPractise16> createState() => _AlgebraMediumPractise16State();
}

class _AlgebraMediumPractise16State extends State<AlgebraMediumPractise16> {
  final List<Map<String,dynamic>> _questions = [
    {'question':'1. Solve: |x + 3| = 7', 'options':['x=4,-10','x=3,-7','x=5,-8','x=6,-9'],'correctIndex':0},
    {'question':'2. Solve: |2x - 1| = 5', 'options':['x=3,-2','x=2,-1','x=1,3','x=4,-2'],'correctIndex':0},
    {'question':'3. Solve: |x - 4| = 6', 'options':['x=10,-2','x=8,-2','x=9,-1','x=7,-3'],'correctIndex':0},
    {'question':'4. Solve: |3x + 2| = 11', 'options':['x=3,-13/3','x=2,-11/3','x=1,-10/3','x=4,-12/3'],'correctIndex':0},
    {'question':'5. Solve: |x - 5| = 9', 'options':['x=14,-4','x=13,-4','x=15,-5','x=12,-3'],'correctIndex':0},
  ];
  ...
  Widget build(BuildContext context){
    return Scaffold(
      ...
      appBar: AppBar(title: const Text('Algebra Medium - Practise 16'), backgroundColor: Colors.green.shade700, centerTitle:true, elevation:3),
      body: SingleChildScrollView(
        padding: const EdgeInsets.all(16),
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children:[
          const Text('Topic: Equations with Absolute Values', style: TextStyle(fontSize:18,fontWeight:FontWeight.w600,color: Colors.green)),
          const SizedBox(height:8),
          const Text('Solve equations involving absolute values.', style: TextStyle(fontSize:15)),
