...
class AlgebraMediumPractise13 extends StatefulWidget {
  ...
  @override
  State<AlgebraMediumPractise13> createState() => _AlgebraMediumPractise13State();
}

class _AlgebraMediumPractise13State extends State<AlgebraMediumPractise13> {
  final List<Map<String,dynamic>> _questions = [
    {'question':'1. Solve for x: A = 5x + 7, if A=27','options':['x=4','x=5','x=3','x=6'],'correctIndex':0},
    {'question':'2. Solve for y: P = 3y - 8, if P=10','options':['y=4','y=5','y=6','y=7'],'correctIndex':1},
    {'question':'3. Solve for x: C = 2x + 10, if C=18','options':['x=3','x=4','x=5','x=6'],'correctIndex':1},
    {'question':'4. Solve for y: M = 4y - 6, if M=14','options':['y=4','y=5','y=6','y=7'],'correctIndex':3},
    {'question':'5. Solve for x: F = 6x + 3, if F=27','options':['x=3','x=4','x=5','x=6'],'correctIndex':2},
  ];
  ...
  Widget build(BuildContext context){
    return Scaffold(
      ...
      appBar: AppBar(title: const Text('Algebra Medium - Practise 13'), backgroundColor: Colors.green.shade700, centerTitle:true, elevation:3),
      body: SingleChildScrollView(
        padding: const EdgeInsets.all(16),
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children:[
          const Text('Topic: Solving for a Variable in Formulas', style: TextStyle(fontSize:18,fontWeight:FontWeight.w600,color: Colors.green)),
          const SizedBox(height:8),
          const Text('Rearrange formulas to solve for the specified variable.', style: TextStyle(fontSize:15)),
