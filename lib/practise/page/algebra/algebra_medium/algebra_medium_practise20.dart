...
class AlgebraMediumPractise20 extends StatefulWidget {
  ...
  @override
  State<AlgebraMediumPractise20> createState() => _AlgebraMediumPractise20State();
}

class _AlgebraMediumPractise20State extends State<AlgebraMediumPractise20> {
  final List<Map<String,dynamic>> _questions = [
    {'question':'1. Solve: -3x + 5 = 2','options':['x=1','x=-1','x=2','x=-2'],'correctIndex':1},
    {'question':'2. Solve: 4 - 2x = 6','options':['x=-1','x=1','x=-2','x=2'],'correctIndex':2},
    {'question':'3. Solve: -5x + 3 = -2','options':['x=1','x=-1','x=2','x=-2'],'correctIndex':0},
    {'question':'4. Solve: 6 - 3x = -3','options':['x=3','x=-3','x=2','x=-2'],'correctIndex':0},
    {'question':'5. Solve: -2x + 7 = 1','options':['x=3','x=-3','x=2','x=-2'],'correctIndex':2},
  ];
  ...
  Widget build(BuildContext context){
    return Scaffold(
      ...
      appBar: AppBar(title: const Text('Algebra Medium - Practise 20'), backgroundColor: Colors.green.shade700, centerTitle:true, elevation:3),
      body: SingleChildScrollView(
        padding: const EdgeInsets.all(16),
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children:[
            const Text('Topic: Solving Equations with Negative Numbers', style: TextStyle(fontSize:18,fontWeight:FontWeight.w600,color: Colors.green)),
            const SizedBox(height:8),
            const Text('Solve equations where coefficients or solutions are negative.', style: TextStyle(fontSize:15)),
