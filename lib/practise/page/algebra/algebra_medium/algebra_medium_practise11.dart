...
class AlgebraMediumPractise11 extends StatefulWidget {
  ...
  @override
  State<AlgebraMediumPractise11> createState() => _AlgebraMediumPractise11State();
}

class _AlgebraMediumPractise11State extends State<AlgebraMediumPractise11> {
  final List<Map<String, dynamic>> _questions = [
    {'question': '1. Solve: 3x + 5 = 2x + 8', 'options': ['x=3', 'x=2', 'x=1', 'x=4'], 'correctIndex': 1},
    {'question': '2. Solve: 4x - 7 = 2x + 5', 'options': ['x=6', 'x=5', 'x=4', 'x=3'], 'correctIndex': 0},
    {'question': '3. Solve: 5x + 2 = 3x + 10', 'options': ['x=3', 'x=4', 'x=5', 'x=6'], 'correctIndex': 1},
    {'question': '4. Solve: 7x - 3 = 4x + 12', 'options': ['x=5', 'x=4', 'x=3', 'x=6'], 'correctIndex': 0},
    {'question': '5. Solve: 6x + 9 = 3x + 18', 'options': ['x=2', 'x=3', 'x=4', 'x=5'], 'correctIndex': 1},
  ];
  ...
  Widget build(BuildContext context){
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Algebra Medium - Practise 11'),
      ...
      body: SingleChildScrollView(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children:[
          const Text('Topic: Linear Equations with Variables on Both Sides', 
              style: TextStyle(fontSize:18,fontWeight:FontWeight.w600,color: Colors.green)),
          const SizedBox(height:8),
          const Text('Solve each linear equation by getting all variables on one side.', style: TextStyle(fontSize:15)),
