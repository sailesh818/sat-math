...
class AlgebraMediumPractise12 extends StatefulWidget {
  ...
  @override
  State<AlgebraMediumPractise12> createState() => _AlgebraMediumPractise12State();
}

class _AlgebraMediumPractise12State extends State<AlgebraMediumPractise12> {
  final List<Map<String,dynamic>> _questions = [
    {'question':'1. Solve: 2(x + 3) = 12','options':['x=3','x=4','x=2','x=5'],'correctIndex':0},
    {'question':'2. Solve: 3(x - 2) = 9','options':['x=3','x=5','x=4','x=6'],'correctIndex':1},
    {'question':'3. Solve: 4(x + 1) = 16','options':['x=3','x=4','x=5','x=2'],'correctIndex':3},
    {'question':'4. Solve: 5(x - 4) = 15','options':['x=5','x=6','x=7','x=8'],'correctIndex':1},
    {'question':'5. Solve: 6(x + 2) = 24','options':['x=2','x=3','x=4','x=5'],'correctIndex':0},
  ];
  ...
  Widget build(BuildContext context){
    return Scaffold(
      ...
      appBar: AppBar(title: const Text('Algebra Medium - Practise 12'), backgroundColor: Colors.green.shade700, centerTitle:true, elevation:3),
      body: SingleChildScrollView(
        padding: const EdgeInsets.all(16),
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children:[
          const Text('Topic: Equations Involving Parentheses', style: TextStyle(fontSize:18,fontWeight:FontWeight.w600,color: Colors.green)),
          const SizedBox(height:8),
          const Text('Simplify and solve equations with parentheses.', style: TextStyle(fontSize:15)),
