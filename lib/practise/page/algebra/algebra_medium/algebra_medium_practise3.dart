...
class _AlgebraMediumPractise3State extends State<AlgebraMediumPractise3> {
  final List<Map<String, dynamic>> _questions = [
    {'question': '1. Solve: (2x + 3) - (x - 4) = 7', 'options': ['x=0', 'x=2', 'x=4', 'x=5'], 'correctIndex': 1},
    {'question': '2. Solve: 3(x - 2) + 4 = 10', 'options': ['x=2', 'x=4', 'x=6', 'x=3'], 'correctIndex': 1},
    {'question': '3. Solve: 5(x +1) - 2 = 3x + 8', 'options': ['x=2', 'x=3', 'x=4', 'x=1'], 'correctIndex': 0},
    {'question': '4. Solve: 2(x -3) + 5 = x + 7', 'options': ['x=8', 'x=5', 'x=6', 'x=4'], 'correctIndex': 3},
    {'question': '5. Solve: 4(x +2) -3 = 3x +5', 'options': ['x=4', 'x=3', 'x=2', 'x=1'], 'correctIndex': 2},
  ];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Algebra Medium - Practise 3', style: TextStyle(color: Colors.white)),
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            const Text('Topic: Equations with Parentheses', style: TextStyle(fontSize: 18, fontWeight: FontWeight.w600, color: Colors.green)),
            const SizedBox(height: 8),
            const Text('Expand and simplify equations with parentheses, then solve.', style: TextStyle(fontSize: 15)),
