...
class AlgebraMediumPractise7 extends StatefulWidget {
  const AlgebraMediumPractise7({super.key});

  @override
  State<AlgebraMediumPractise7> createState() => _AlgebraMediumPractise7State();
}

class _AlgebraMediumPractise7State extends State<AlgebraMediumPractise7> {
  final List<Map<String,dynamic>> _questions = [
    {'question':'1. Solve: 0.5x + 2.5 = 5.5','options':['x=6','x=4','x=5','x=3'],'correctIndex':1},
    {'question':'2. Solve: 1.2x - 0.6 = 2.4','options':['x=2','x=3','x=1','x=2.5'],'correctIndex':3},
    {'question':'3. Solve: 0.3x + 0.7 = 1.6','options':['x=2','x=3','x=4','x=5'],'correctIndex':1},
    {'question':'4. Solve: 2.5x -1.5 = 3.5','options':['x=2','x=3','x=1','x=5'],'correctIndex':1},
    {'question':'5. Solve: 0.8x +1.2 = 3.2','options':['x=2.5','x=2','x=3','x=1.5'],'correctIndex':0},
  ];
  ...
  Widget build(BuildContext context){
    return Scaffold(
      ...
      appBar: AppBar(title: const Text('Algebra Medium - Practise 7'), backgroundColor: Colors.green.shade700, centerTitle:true, elevation:3),
      body: SingleChildScrollView(
        padding: const EdgeInsets.all(16),
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children:[
          const Text('Topic: Equations with Decimals', style: TextStyle(fontSize:18,fontWeight:FontWeight.w600,color: Colors.green)),
          const SizedBox(height:8),
          const Text('Solve each equation involving decimal numbers.', style: TextStyle(fontSize:15)),
