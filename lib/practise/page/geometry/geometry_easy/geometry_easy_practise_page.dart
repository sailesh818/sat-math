...
class GeometryEasyPractisePage extends StatefulWidget {
  final String jsonFileName;
  final String title;

  const GeometryEasyPractisePage({
    super.key,
  ...
  @override
  State<GeometryEasyPractisePage> createState() =>
      _GeometryEasyPractisePageState();
}

class _GeometryEasyPractisePageState extends State<GeometryEasyPractisePage> {
  ...
  Future<void> loadQuestions() async {
    try {
      final String response = await rootBundle.loadString(
          'assets/geometry/geometryeasy/${widget.jsonFileName}');
