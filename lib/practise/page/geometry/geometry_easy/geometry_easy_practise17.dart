...
class GeometryEasyPractise17 extends StatefulWidget {
  const GeometryEasyPractise17({super.key});

  @override
  State<GeometryEasyPractise17> createState() => _GeometryEasyPractise17State();
}

class _GeometryEasyPractise17State extends State<GeometryEasyPractise17> {
  ...
  final List<Map<String, dynamic>> questions = [
    {
      ...
      'explanation': 'Since 9² + 12² = 15², it is a right triangle.'
    },
    {
      'question': '2. A rectangle has a length of 13 cm and a width of 8 cm. What is its area?',
      'options': ['104 cm²', '100 cm²', '110 cm²', '108 cm²'],
      'correctIndex': 0,
      'hint': 'Area = length × width',
      'explanation': 'Area = 13 × 8 = 104 cm²'
    },
    {
      'question': '3. A circle has a diameter of 16 cm. What is its circumference? (Use π ≈ 3.14)',
      'options': ['50.24 cm', '48 cm', '52 cm', '51 cm'],
      'correctIndex': 0,
      'hint': 'Circumference = π × diameter',
      'explanation': 'Circumference = 3.14 × 16 ≈ 50.24 cm'
    },
    {
      'question': '4. A square has an area of 144 cm². What is the length of its diagonal?',
      'options': ['12√2 cm', '24 cm', '14 cm', '16 cm'],
      'correctIndex': 0,
      'hint': 'Diagonal = side × √2',
      'explanation': 'Side = √144 = 12, so diagonal = 12 × √2 = 12√2 cm'
    },
    {
