...
class _GeometryEasyPractise6State extends State<GeometryEasyPractise6> {
  final List<Map<String, Object>> _questions = [
    {
      'question': '1. A right triangle has a hypotenuse of 13 cm and one leg of 5 cm. What is the other leg?',
    ...
    {
      'question': '4. A circle has a radius of 6 cm. What is its circumference? (Use π ≈ 3.14)',
