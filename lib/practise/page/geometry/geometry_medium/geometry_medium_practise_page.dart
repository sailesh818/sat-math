...
class GeometryMediumPractisePage extends StatefulWidget {
  final String jsonFileName;
  final String title;

  const GeometryMediumPractisePage({
    super.key,
  ...
  @override
  State<GeometryMediumPractisePage> createState() =>
      _GeometryMediumPractisePageState();
}

class _GeometryMediumPractisePageState extends State<GeometryMediumPractisePage> {
  ...
  Future<void> loadQuestions() async {
    try {
      final String response = await rootBundle.loadString(
          'assets/geometry/geometrymedium/${widget.jsonFileName}');
  ...
  void nextQuestion() async {
    if (currentQuestionIndex < questions.length - 1) {
      ...
      int basePoints = 8 + correctCount; // Medium gets slightly higher base
  ...
  Future<void> _useHint() async {
    ...
    if (totalPoints >= 3) { // Medium costs more for hint
