...
class GeometryHardPractisePage extends StatefulWidget {
  final String jsonFileName;
  final String title;

  const GeometryHardPractisePage({
    super.key,
  ...
  @override
  State<GeometryHardPractisePage> createState() =>
      _GeometryHardPractisePageState();
}

class _GeometryHardPractisePageState extends State<GeometryHardPractisePage> {
  ...
  Future<void> loadQuestions() async {
    try {
      final String response = await rootBundle.loadString(
          'assets/geometry/geometryhard/${widget.jsonFileName}');
  ...
  void nextQuestion() async {
    if (currentQuestionIndex < questions.length - 1) {
      ...
      int basePoints = 10 + correctCount; // Hard level higher base points
  ...
  Future<void> _useHint() async {
    ...
    if (totalPoints >= 5) { // Hard hint costs more points
      await savePointsToFirebase(-5);
      setState(() {
        showHint = true;
        hintPenalty += 5;
