  ...
  final List<Map<String, dynamic>> questions = [
    {
      ...
      'explanation': 'Hypotenuse = √(12² + 35²) = √(144 + 1225) = √1369 = 37 cm.',
    },
    {
      ...
      'correctIndex': 0,
      'hint': 'Area of circle = π * r², then take 3/4 of it.',
      'explanation': 'Area = 0.75 * 3.14 * 9² = 0.75 * 3.14 * 81 ≈ 190.425 cm².',
    },
    {
      'question': '3. A square has perimeter 80 cm. What is the length of its diagonal?',
      'options': ['20√2 cm', '19√2 cm', '18√2 cm', '21 cm'],
      'correctIndex': 0,
      'hint': 'Side length = perimeter / 4, diagonal = side * √2.',
      'explanation': 'Side = 80 / 4 = 20 cm, diagonal = 20 * √2 = 20√2 cm.',
    },
    {
      ...
      'explanation': 'Area = 0.5 * (14 + 26) * 10 = 0.5 * 40 * 10 = 200 cm².',
    },
    {
      ...
      'explanation': 'Height = 24 * √3 / 2 = 12√3 cm.',
    },
  ];
