...
class FunctionsHardPractisePage extends StatefulWidget {
  final String jsonFileName;
  final String title;

  const FunctionsHardPractisePage({
    super.key,
  ...
  @override
  State<FunctionsHardPractisePage> createState() =>
      _FunctionsHardPractisePageState();
}

class _FunctionsHardPractisePageState extends State<FunctionsHardPractisePage> {
  ...
  Future<void> loadQuestions() async {
    try {
      final String response = await rootBundle.loadString(
          'assets/functions/functionshard/${widget.jsonFileName}');
