...
class _FunctionsEasyPractise5State extends State<FunctionsEasyPractise5> {
  ...
  final List<Map<String, dynamic>> questions = [
    {
      ...
      'explanation': 'f(3) = 3 + 4 = 7'
    },
    {
      'question': '2. If g(x) = 2x - 5, what is g(4)?',
      'options': ['3', '2', '4', '8'],
      'correctIndex': 0,
      'hint': 'Substitute x = 4 into g(x).',
      'explanation': 'g(4) = 2*4 - 5 = 8 - 5 = 3'
    },
    {
      'question': '3. If h(x) = x², what is h(5)?',
      'options': ['10', '20', '25', '15'],
      'correctIndex': 2,
      'hint': 'Square the value of x.',
      'explanation': 'h(5) = 5² = 25'
    },
    {
      'question': '4. If f(x) = 3x + 2, what is the value of f(0)?',
      'options': ['2', '3', '0', '5'],
      'correctIndex': 0,
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Functions Easy - Practise 5'),
