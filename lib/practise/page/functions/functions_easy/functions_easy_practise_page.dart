...
class FunctionsEasyPractisePage extends StatefulWidget {
  final String jsonFileName;
  final String title;

  const FunctionsEasyPractisePage({
    super.key,
  ...
  @override
  State<FunctionsEasyPractisePage> createState() =>
      _FunctionsEasyPractisePageState();
}

class _FunctionsEasyPractisePageState extends State<FunctionsEasyPractisePage> {
  ...
  Future<void> loadQuestions() async {
    try {
      final String response = await rootBundle.loadString(
          'assets/functions/functionseasy/${widget.jsonFileName}');
  ...
  void _loadRewardedAd() {
    RewardedAd.load(
      adUnitId: 'ca-app-pub-6704136477020125/4913789019', // Real ID
