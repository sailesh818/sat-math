...
class FunctionsEasyPractise21 extends StatefulWidget {
  ...
  @override
  State<FunctionsEasyPractise21> createState() =>
      _FunctionsEasyPractise21State();
}
...
class _FunctionsEasyPractise21State extends State<FunctionsEasyPractise21> {
  ...
  final List<Map<String, dynamic>> questions = [
    {
      ...
      'correctIndex': 1,
      'hint': 'Add 8 to 1.',
      'explanation': 'f(1) = 1 + 8 = 9'
    },
    {
      'question': '2. If g(x) = 2x + 3, find g(4).',
      'options': ['10', '11', '12', '9'],
      'correctIndex': 1,
      'hint': 'Multiply 4 by 2 and add 3.',
      'explanation': 'g(4) = 2*4 + 3 = 8 + 3 = 11'
    },
    {
      'question': '3. If f(x) = x² − 3, what is f(3)?',
      'options': ['6', '9', '7', '8'],
      'correctIndex': 0,
      'hint': 'Square 3 and subtract 3.',
      'explanation': 'f(3) = 3² − 3 = 9 − 3 = 6'
    },
    {
      'question': '4. If h(x) = 1/(x + 4), find h(1).',
      'options': ['0.2', '0.25', '0.3', '0.33'],
      'correctIndex': 0,
      'hint': 'Add 4 to 1 and take reciprocal.',
      'explanation': 'h(1) = 1 / (1 + 4) = 1/5 = 0.2'
    },
    {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Functions - Easy Practice 21'),
