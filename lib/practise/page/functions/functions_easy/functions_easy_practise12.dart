...
class _FunctionsEasyPractise12State extends State<FunctionsEasyPractise12> {
  ...
  final List<Map<String, dynamic>> questions = [
    ...
    },
    {
      ...
      'options': ['2', '3', '4', '5'],
      'correctIndex': 1,
      'hint': 'Multiply 4 by 2 and subtract 5.',
    ...
    },
    {
      ...
      'correctIndex': 2,
      'hint': 'Add 2 to x, then take reciprocal.',
      'explanation': 'h(2) = 1/(2 + 2) = 1/4'
    },
    {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Functions - Easy Practise 12'),
