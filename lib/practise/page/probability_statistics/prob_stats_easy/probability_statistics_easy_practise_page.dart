...
class ProbabilityStatisticsEasyPractisePage extends StatefulWidget {
  final String jsonFileName;
  final String title;

  const ProbabilityStatisticsEasyPractisePage({
    super.key,
  ...
  @override
  State<ProbabilityStatisticsEasyPractisePage> createState() =>
      _ProbabilityStatisticsEasyPractisePageState();
}

class _ProbabilityStatisticsEasyPractisePageState
    extends State<ProbabilityStatisticsEasyPractisePage> {
  ...
  Future<void> loadQuestions() async {
    try {
      final String response = await rootBundle.loadString(
          'assets/probability/probabilityeasy/${widget.jsonFileName}');
  ...
  void nextQuestion() async {
    if (currentQuestionIndex < questions.length - 1) {
      ...
      int basePoints = 5 + correctCount; // Easy level base points
  ...
  Future<void> _useHint() async {
    ...
    if (totalPoints >= 2) { // Easy hint costs 2 points
      ...
      showDialog(
        ...
        builder: (_) => AlertDialog(
          ...
          content: const Text("You need 2 points. Watch an ad to unlock hint?"),
          actions: [
            TextButton(
              onPressed: () => Navigator.pop(context),
