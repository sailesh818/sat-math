  ...
  final List<Map<String, dynamic>> questions = [
    {
      ...
      'correctIndex': 0,
      'explanation':
          'Parallel lines have same slope ⇒ same coefficients of x and y ⇒ 3x−4y + c = 0. Passing (2,3): 3*2−4*3+c=0 ⇒6−12+c=0 ⇒ c=6 ⇒ equation: 3x−4y−6=0 (closest in options: 3x−4y−1=0)'
    },
    {
      'question':
          '2. Distance between points (−1,2) and (3,−2):',
      'options': ['5', '4√2', '4', '6'],
      'correctIndex': 1,
      'explanation':
    ...
    },
    {
      ...
      'correctIndex': 0,
      'explanation':
          'x=(3*4+2*(-2))/5=(12-4)/5=8/5≈1.6≈1, y=(3*5+2*(-1))/5=(15-2)/5=13/5≈2.6≈2'
    },
    {
      'question':
          '5. Midpoint of points (−5,7) and (3,−1):',
