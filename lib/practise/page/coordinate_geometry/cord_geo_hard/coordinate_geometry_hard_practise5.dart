...
class _CoordinateGeometryHardPractise5State
  ...
  final List<Map<String, dynamic>> questions = [
    ...
    {
      'question':
          '2. Distance between points (−4,5) and (3,−1):',
      'options': ['√85', '√75', '√80', '√81'],
      'correctIndex': 0,
      'explanation':
    ...
    {
      'question':
          '3. The line joining (2,−1) and (5,k) has slope 2. Find k.',
      'options': ['5', '7', '−1', '3'],
      'correctIndex': 1,
      'explanation':
    ...
    {
      'question':
          '4. Midpoint of segment joining (−3,8) and (7,−2):',
      'options': ['(2,3)', '(0,3)', '(2,2)', '(3,3)'],
      'correctIndex': 0,
      'explanation':
          'Midpoint = ((−3+7)/2, (8+−2)/2)=(4/2,6/2)=(2,3)'
    },
    {
      'question':
          '5. Check if points (1,2), (4,5), (7,8) are collinear.',
