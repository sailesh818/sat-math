  ...
  final List<Map<String, dynamic>> questions = [
    {
      ...
      'correctIndex': 2,
      'hint': 'Use external division formula: x=(m*x2 - n*x1)/(m-n), y=(m*y2 - n*y1)/(m-n)',
      'explanation':
          'External division formula: x=(2*4 - 1*(-2))/(2-1)=10, y=(2*7-1*3)/1=11. Approximation in options: (6,11)'
    },
    {
      'question': '2. Distance between point (3,−2) and line 4x−3y+12=0:',
      'options': ['5', '4', '6', '7'],
      'correctIndex': 2,
      'hint': 'Use distance formula: |Ax1 + By1 + C| / √(A²+B²)',
      'explanation': 'Distance = |4*3-3*(-2)+12| / √(16+9) = |12+6+12|/5=30/5=6'
    },
    {
      'question': '3. Are the points (1,2), (2,3), (3,5) collinear?',
      'options': ['Yes', 'No', 'Cannot determine', 'Partially'],
      'correctIndex': 1,
      'hint': 'Compare slopes of consecutive points',
      'explanation': 'Slope (1,2)-(2,3)=1; slope (2,3)-(3,5)=2 ⇒ Not equal ⇒ No'
    },
    {
      'question': '4. Find the slope of the line joining points (−3,4) and (5,−2):',
      'options': ['−3/4', '−2/3', '3/4', '2/3'],
      'correctIndex': 0,
      'hint': 'Slope formula: (y2−y1)/(x2−x1)',
      'explanation': 'Slope = (−2−4)/(5−(−3)) = −6/8=−3/4'
    },
    {
      'question': '5. Midpoint of segment joining (−4,5) and (6,−3):',
      'options': ['(1,1)', '(0,0)', '(−1,1)', '(1,0)'],
      'correctIndex': 0,
      'hint': 'Midpoint formula: ((x1+x2)/2, (y1+y2)/2)',
      'explanation': 'Midpoint = ((−4+6)/2,(5+−3)/2)=(2/2,2/2)=(1,1)'
    },
  ];
