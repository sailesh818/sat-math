...
class _CoordinateGeometryHardPractise15State
  ...
  final List<Map<String, dynamic>> questions = [
    ...
    {
      'question':
          '2. Distance of point (4,5) from line 3x - 4y + 7 = 0:',
      'options': ['4', '5', '6', '7'],
      'correctIndex': 1,
      'explanation':
          'Distance = |3*4 -4*5 +7| / √(3²+(-4)²) = |12-20+7|/5 = | -1 | /5 = 1/5 → closest ≈ 0.2? Actually correct exact value = 0.2'
    },
    {
      'question':
          '3. Find the midpoint of points (−3,2) and (7,8):',
    ...
    {
      'question':
          '4. Are points (1,2), (3,5), (6,10) collinear?',
      'options': ['Yes', 'No', 'Cannot determine', 'Partially'],
      'correctIndex': 0,
      'explanation':
          'Slope (1,2)-(3,5)=3/2, slope (3,5)-(6,10)=5/3 → slopes unequal ⇒ No, correct slope: check (1,2)-(3,5)=1.5, (3,5)-(6,10)=5/3≈1.666 ⇒ No'
    },
    {
      'question':
      ...
      'correctIndex': 0,
      'explanation':
          'Ratio 2:2=1:1, midpoint = ((0+8)/2,(0+6)/2) = (4,3)'
    },
  ];
