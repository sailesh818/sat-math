  ...
  final List<Map<String, dynamic>> questions = [
    {
      ...
      'hint': 'Parallel line has same coefficients for x and y: 5x - 2y + c = 0',
      'correctIndex': 2,
      'explanation':
          'Passes through (2,3): 5*2 - 2*3 + c = 0 ⇒ 10 - 6 + c = 0 ⇒ c = -4 ⇒ 5x - 2y - 4 = 0'
    },
    {
      'question': '2. Distance of point (3,-2) from line 4x + 3y - 12 = 0:',
      'options': ['3', '2', '1', '4'],
      'hint': 'Distance formula: |Ax+By+C| / √(A²+B²)',
      'correctIndex': 0,
      'explanation':
          'Distance = |4*3 + 3*(-2) -12| / √(16+9) = |12-6-12|/5 = 6/5 = 1.2'
    },
    {
      'question': '3. Midpoint of points (5,-3) and (-1,7):',
    ...
    {
      'question': '4. Check collinearity of points (0,0), (2,3), (4,6):',
      'options': ['Yes', 'No', 'Cannot determine', 'Partially'],
      'hint': 'Compare slopes of consecutive points',
      'correctIndex': 0,
      'explanation':
          'Slope (0,0)-(2,3)=3/2, slope (2,3)-(4,6)=3/2 ⇒ slopes equal ⇒ points are collinear'
    },
    {
      'question':
          '5. Find the point dividing line joining (1,2) and (7,8) internally in ratio 2:1:',
      'options': ['(5,6)', '(3,4)', '(4,5)', '(2,3)'],
      'hint': 'Internal division formula: ((m*x2+n*x1)/(m+n), (m*y2+n*y1)/(m+n))',
      'correctIndex': 0,
      'explanation':
