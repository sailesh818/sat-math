...
class CoordinateGeometryHardPractisePage extends StatefulWidget {
  final String jsonFileName;
  final String title;

  const CoordinateGeometryHardPractisePage({
    super.key,
  ...
  @override
  State<CoordinateGeometryHardPractisePage> createState() =>
      _CoordinateGeometryHardPractisePageState();
}

class _CoordinateGeometryHardPractisePageState
    extends State<CoordinateGeometryHardPractisePage> {
  ...
  void nextQuestion() async {
    if (currentQuestionIndex < questions.length - 1) {
      ...
      int basePoints = 8 + correctCount; // harder level = more points
  ...
  void _loadRewardedAd() {
    RewardedAd.load(
      adUnitId: 'ca-app-pub-6704136477020125/4913789019', // REAL AD
    ...
    _rewardedAd!.show(
      onUserEarnedReward: (ad, reward) async {
        if (forHint) {
          ...
          await savePointsToFirebase(8); // hard level reward
          ScaffoldMessenger.of(context).showSnackBar(
