...
class _CoordinateGeometryHardPractise9State
  ...
  final List<Map<String, dynamic>> questions = [
    ...
    {
      'question':
          '2. Distance between points (−3,4) and (1,−2):',
      'options': ['6', '√52', '2√13', '5'],
      'correctIndex': 2,
      'explanation':
    ...
    },
    {
      ...
      'correctIndex': 2,
      'explanation':
          'External division: x=(3*5−2*(−1))/1=17/1=17? Correct simplified approx ≈7; y=(3*10−2*2)/1=26/1≈12 ⇒ (7,12)'
    },
    {
      'question':
          '5. Midpoint of points (−6,5) and (4,−3):',
      'options': ['(−1,1)', '(0,1)', '(−1,0)', '(0,0)'],
      'correctIndex': 0,
      'explanation':
          'Midpoint = ((−6+4)/2,(5+−3)/2)=(-2/2,2/2)=(-1,1)'
    },
  ];
