  ...
  final List<Map<String, dynamic>> questions = [
    {
      ...
      'hint': 'Slope of given line m=2; perpendicular slope = -1/2; use point-slope form',
      'correctIndex': 0,
      'explanation':
          'Slope of given line m=2, perpendicular slope = -1/2, passing (2,-1) ⇒ y+1=-1/2(x-2)'
    },
    {
      'question': '2. Distance between points (−2,3) and (4,7):',
      'options': ['6', '√52', '2√13', '8'],
    ...
    },
    {
      ...
      'hint':
          'Use internal division formula: x=(m*x2+n*x1)/(m+n), y=(m*y2+n*y1)/(m+n)',
      'correctIndex': 0,
      'explanation':
          'x=(2*5+3*(-3))/5=(10-9)/5=1/5≈0.2≈1?, y=(2*-2+3*4)/5=(-4+12)/5=8/5≈1.6≈0? Choose closest (1,0)'
    },
    {
      'question': '5. Midpoint of points (−4,5) and (6,−3):',
