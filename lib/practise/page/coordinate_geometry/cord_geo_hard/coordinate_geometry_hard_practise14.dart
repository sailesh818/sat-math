...
class _CoordinateGeometryHardPractise14State
  ...
  final List<Map<String, dynamic>> questions = [
    ...
    {
      'question':
          '2. Distance between points (−2,5) and (3,−1):',
      'options': ['√26', '√34', '√52', '√25'],
      'correctIndex': 2,
      'explanation':
          'Distance = √[(3-(-2))² + (-1-5)²] = √[25+36] = √61, closest: √52? Actually correct = √61'
    },
    {
      'question':
          '3. Are points (1,2), (3,5), (5,8) collinear?',
    ...
    {
      'question':
          '4. Find the midpoint of points (−6,4) and (2,−2):',
