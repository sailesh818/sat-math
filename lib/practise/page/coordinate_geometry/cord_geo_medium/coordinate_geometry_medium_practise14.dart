...
class _CoordinateGeometryMediumPractise14State
  ...
  final List<Map<String, dynamic>> questions = [
    ...
    {
      'question':
          '3. Are points (1,2), (4,6), (5,8) collinear?',
      'options': ['Yes', 'No', 'Cannot Determine', 'Partially'],
      'correctIndex': 1,
      'explanation':
          'Slope 1-2 = (6−2)/(4−1)=4/3; slope 2-3 = (8−6)/(5−4)=2/1=2 ⇒ Not collinear'
    },
    {
      'question':
          '4. Distance between points (−2,−3) and (2,1):',
      'options': ['√20', '√18', '√16', '√25'],
      'correctIndex': 0,
      'explanation':
    ...
    {
      'question':
          '5. Equation of line passing through (−1,1) with slope 2:',
      'options': [
        'y−1 = 2(x+1)',
        'y+1 = 2(x+1)',
        'y−1 = −2(x+1)',
