  ...
  final List<Map<String, dynamic>> questions = [
    {
      ...
      'correctIndex': 2,
      'explanation':
          'Slope = (−2−2)/(−2−6) = (−4)/(-8) = 1/2. Wait, correct slope = 1/2'
    },
    {
      'question':
          '2. Find the midpoint of points (0,−4) and (6,2).',
      'options': ['(3,−1)', '(3,−2)', '(2,−1)', '(3,0)'],
      'correctIndex': 0,
      'explanation':
          'Midpoint = ((0+6)/2, (−4+2)/2) = (6/2, −2/2) = (3, −1)'
    },
    {
      'question':
          '3. Are the points (2,3), (4,7), (6,11) collinear?',
    ...
    },
    {
      ...
      'correctIndex': 0,
      'explanation':
          'Distance = √[(3−(−1))² + (2−(−2))²] = √[(4)² + (4)²] = √(16+16) = √32'
    },
    {
      'question':
          '5. Equation of line passing through (1,−1) with slope −3:',
      'options': [
        'y+1 = −3(x−1)',
        'y−1 = −3(x−1)',
        'y+1 = 3(x−1)',
