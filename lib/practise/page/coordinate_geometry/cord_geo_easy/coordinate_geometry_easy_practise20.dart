...
class _CoordinateGeometryEasyPractise20State
  ...
  final List<Map<String, dynamic>> questions = [
    {
      'question': '1. Distance between points (2,−1) and (5,3) is:',
      'options': ['5', '√20', '√13', '6'],
      'correctIndex': 0,
      'hint': 'Distance formula: √[(x2−x1)² + (y2−y1)²]',
      'explanation': 'Distance = √[(5−2)² + (3−(−1))²] = √[9 + 16] = √25 = 5'
    },
    {
    ...
    },
    {
      ...
      'correctIndex': 0,
      'hint': 'Point-slope form: y−y1 = m(x−x1)',
      'explanation': 'y−3 = 1(x−2) ⇒ y = x + 1'
    },
    {
      'question': '5. Are points (1,2), (3,4), (5,6) collinear?',
  ...
  void _loadRewardedAd() {
    RewardedAd.load(
      adUnitId: 'ca-app-pub-6704136477020125/4913789019', // replace with your ad unit
