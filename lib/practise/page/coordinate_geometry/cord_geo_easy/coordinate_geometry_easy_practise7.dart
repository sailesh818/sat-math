...
class _CoordinateGeometryEasyPractise7State
  ...
  final List<Map<String, dynamic>> questions = [
    {
      'question': '1. Find the slope of the line perpendicular to y = 2x + 3.',
      'options': ['2', '-2', '1/2', '-1/2'],
      'correctIndex': 3,
    ...
    {
      'question': '2. Determine if the lines y = 3x + 1 and y = 3x − 4 are parallel.',
    ...
    {
      'question': '3. Find the x-intercept of the line 5x − 2y + 10 = 0.',
    ...
    {
      'question': '4. The equation of a line passing through (1, 2) with slope -3 is:',
    ...
    {
      'question': '5. Check if the line y = 1/2 x + 4 is parallel to the line y = 1/2 x − 1.',
