  ...
  final List<Map<String, dynamic>> questions = [
    {
      ...
      'explanation': 'Distance = √[(4−1)² + (9−5)²] = √[9 + 16] = √25 = 5'
    },
    {
      ...
      'explanation': 'Midpoint = ((−3+3)/2, (2+8)/2) = (0,5)'
    },
    {
      ...
      'explanation': 'Slope = (15−3)/(5−2) = 12/3 = 4'
    },
    {
      'question': '4. Equation of line passing through (1,1) with slope 3 is:',
    ...
    {
      'question': '5. Are points (0,0), (2,2), (4,4) collinear?',
      'options': ['Yes', 'No', 'Cannot determine', 'Partially'],
      'correctIndex': 0,
      'hint': 'Check if slopes between consecutive points are equal',
      'explanation': 'Slope (0,0)-(2,2)=1, slope (2,2)-(4,4)=1 ⇒ collinear'
    },
  ];
