...
class TrigonometryHardPractise14 extends StatefulWidget {
  ...
  @override
  State<TrigonometryHardPractise14> createState() => _TrigonometryHardPractise14State();
}

class _TrigonometryHardPractise14State extends State<TrigonometryHardPractise14> {
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            const Text(
              'Topic: SAT Math – Advanced Trigonometric Equations and Functions',
              style: TextStyle(
                  fontSize: 18,
            ...
            const Text(
              'Practice challenging SAT-level problems with trigonometric functions, identities, and inverse functions.',
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      ...List.generate(question['options'].length, (optIndex) {
                        ...
                        Color? tileColor;
                        if (hasAnswered) {
                          if (isSelected && isCorrect) tileColor = Colors.blueGrey.shade100;
                          else if (isSelected && !isCorrect) tileColor = Colors.red.shade100;
                          else if (isCorrect) tileColor = Colors.blueGrey.shade50;
                        }
