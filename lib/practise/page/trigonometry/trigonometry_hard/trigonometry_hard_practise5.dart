...
class TrigonometryHardPractise5 extends StatefulWidget {
  ...
  @override
  State<TrigonometryHardPractise5> createState() => _TrigonometryHardPractise5State();
}
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            const Text(
              'Topic: SAT Math – Advanced Trigonometric Equations and Applications',
              style: TextStyle(
                  fontSize: 18,
            ...
            const Text(
              'Practice complex-level problems on trigonometric equations, ratios, and real-world applications.',
