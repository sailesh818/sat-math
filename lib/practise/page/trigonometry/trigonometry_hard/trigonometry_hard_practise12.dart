...
class TrigonometryHardPractise12 extends StatefulWidget {
  ...
  @override
  State<TrigonometryHardPractise12> createState() => _TrigonometryHardPractise12State();
}

class _TrigonometryHardPractise12State extends State<TrigonometryHardPractise12> {
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            const Text(
              'Topic: SAT Math – Advanced Trigonometric Identities and Inverse Functions',
              style: TextStyle(
                  fontSize: 18,
            ...
            const Text(
              'Practice solving advanced trigonometric equations, using identities, periodicity, and inverse functions.',
