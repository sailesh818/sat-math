...
class TrigonometryHardPractise20 extends StatefulWidget {
  ...
  @override
  State<TrigonometryHardPractise20> createState() => _TrigonometryHardPractise20State();
}

class _TrigonometryHardPractise20State extends State<TrigonometryHardPractise20> {
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            const Text(
              'Topic: SAT Math – Advanced Trigonometric Functions, Identities, and Inverse Functions',
              style: TextStyle(
                  fontSize: 18,
            ...
            const Text(
              'Practice challenging SAT-level problems including trigonometric equations, periodicity, amplitude, and inverse functions.',
