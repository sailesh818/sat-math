...
class TrigonometryHardPractisePage extends StatefulWidget {
  final String jsonFileName;
  final String title;

  const TrigonometryHardPractisePage({
    super.key,
  ...
  @override
  State<TrigonometryHardPractisePage> createState() =>
      _TrigonometryHardPractisePageState();
}

class _TrigonometryHardPractisePageState
    extends State<TrigonometryHardPractisePage> {
  ...
  Future<void> loadQuestions() async {
    try {
      final String response = await rootBundle.loadString(
          'assets/trigonometry/trigonometryhard/${widget.jsonFileName}');
  ...
  Future<void> _useHint() async {
    ...
    if (totalPoints >= 4) { // Hard hint costs 4 points
      ...
      showDialog(
        ...
        builder: (_) => AlertDialog(
          ...
          content: const Text("You need 4 points. Watch an ad to unlock hint?"),
          actions: [
            TextButton(
              onPressed: () => Navigator.pop(context),
