...
class TrigonometryHardPractise16 extends StatefulWidget {
  ...
  @override
  State<TrigonometryHardPractise16> createState() => _TrigonometryHardPractise16State();
}

class _TrigonometryHardPractise16State extends State<TrigonometryHardPractise16> {
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            const Text(
              'Topic: SAT Math – Advanced Trigonometric Equations, Functions, and Identities',
              style: TextStyle(
                  fontSize: 18,
            ...
            const Text(
              'Practice hard SAT-level problems involving trigonometric functions, inverse functions, and periodicity.',
