...
class TrigonometryMediumPractise5 extends StatefulWidget {
  ...
  @override
  State<TrigonometryMediumPractise5> createState() => _TrigonometryMediumPractise5State();
}

class _TrigonometryMediumPractise5State extends State<TrigonometryMediumPractise5> {
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text(
              'Practice medium-level trigonometric problems including right triangle ratios, exact values, and combined angle sums.',
