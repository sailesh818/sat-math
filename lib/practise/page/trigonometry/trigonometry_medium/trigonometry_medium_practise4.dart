...
class TrigonometryMediumPractise4 extends StatefulWidget {
  ...
  @override
  State<TrigonometryMediumPractise4> createState() => _TrigonometryMediumPractise4State();
}

class _TrigonometryMediumPractise4State extends State<TrigonometryMediumPractise4> {
  final List<Map<String, dynamic>> _questions = [
    ...
    {
      'question': '5. The hypotenuse of a right triangle is 26 and one leg is 10. What is sin θ opposite the leg of length 10?',
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text(
              'Practice medium-level trigonometric problems including right triangle ratios, exact values, and difference of angles.',
