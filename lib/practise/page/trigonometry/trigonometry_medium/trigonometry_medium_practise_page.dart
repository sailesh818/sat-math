...
class TrigonometryMediumPractisePage extends StatefulWidget {
  final String jsonFileName;
  final String title;

  const TrigonometryMediumPractisePage({
    super.key,
  ...
  @override
  State<TrigonometryMediumPractisePage> createState() =>
      _TrigonometryMediumPractisePageState();
}

class _TrigonometryMediumPractisePageState
    extends State<TrigonometryMediumPractisePage> {
  ...
  Future<void> loadQuestions() async {
    try {
      final String response = await rootBundle.loadString(
          'assets/trigonometry/trigonometrymedium/${widget.jsonFileName}');
