...
class TrigonometryMediumPractise16 extends StatefulWidget {
  const TrigonometryMediumPractise16({super.key});

  @override
  State<TrigonometryMediumPractise16> createState() => _TrigonometryMediumPractise16State();
}

class _TrigonometryMediumPractise16State extends State<TrigonometryMediumPractise16> {
  final List<Map<String, dynamic>> _questions = [
    ...
    {
      'question': '4. A triangle has sides 9, 40, 41. What is cos θ adjacent to the side of length 9?',
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text(
          'Trigonometry Medium - Practise 16',
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            const Text(
              'Topic: SAT Math – Trigonometric Ratios and Pythagorean Theorem Applications',
              style: TextStyle(
                  fontSize: 18,
            ...
            const Text(
              'Practice medium-level problems on trigonometric ratios and applying the Pythagorean theorem in right triangles.',
