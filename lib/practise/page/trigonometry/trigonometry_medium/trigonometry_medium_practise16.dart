...
class TrigonometryMediumPractise16 extends StatefulWidget {
  ...
  @override
  State<TrigonometryMediumPractise16> createState() =>
      _TrigonometryMediumPractise16State();
}

class _TrigonometryMediumPractise16State
    extends State<TrigonometryMediumPractise16> {
  ...
  final List<Map<String, dynamic>> questions = [
    {
      ...
      'explanation': 'Adjacent = √(25² - 24²) = 7, so cos θ = 7/25'
    },
    {
    ...
    },
    {
      ...
      'explanation': 'sin 30° × cos 60° = (1/2)*(1/2) = 1/4 → correct answer is 1/4'
    },
    {
