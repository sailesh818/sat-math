...
class TrigonometryMediumPractise2 extends StatefulWidget {
  ...
  @override
  State<TrigonometryMediumPractise2> createState() => _TrigonometryMediumPractise2State();
}

class _TrigonometryMediumPractise2State extends State<TrigonometryMediumPractise2> {
  final List<Map<String, dynamic>> _questions = [
    {
      'question': '1. In a right triangle, opposite = 8 and hypotenuse = 17. What is sin θ?',
    ...
    {
      'question': '4. A right triangle has sides 9, 12, 15. What is cos θ opposite the side 9?',
