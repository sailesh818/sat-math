...
class TrigonometryMediumPractise12 extends StatefulWidget {
  ...
  @override
  State<TrigonometryMediumPractise12> createState() => _TrigonometryMediumPractise12State();
}

class _TrigonometryMediumPractise12State extends State<TrigonometryMediumPractise12> {
  final List<Map<String, dynamic>> _questions = [
    {
      'question': '1. In a right triangle, opposite = 24 and hypotenuse = 30. Find cos θ.',
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            const Text(
              'Topic: SAT Math – Right Triangle Trigonometric Functions & Ratios',
              style: TextStyle(
                  fontSize: 18,
            ...
            const Text(
              'Practice advanced right triangle trigonometric problems including sin, cos, tan, and their respective ratios.',
