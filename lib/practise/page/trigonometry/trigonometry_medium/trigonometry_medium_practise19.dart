...
class TrigonometryMediumPractise19 extends StatefulWidget {
  ...
  @override
  State<TrigonometryMediumPractise19> createState() => _TrigonometryMediumPractise19State();
}

class _TrigonometryMediumPractise19State extends State<TrigonometryMediumPractise19> {
  final List<Map<String, dynamic>> _questions = [
    ...
    {
      'question': '4. A triangle has sides 15, 36, 39. What is cos θ adjacent to the side of length 15?',
      'options': ['15/39', '36/39', '39/15', '15/36'],
      'correctIndex': 1,
    },
    {
      'question': '5. If cos θ = 16/64, find sin θ in the right triangle.',
      'options': ['48/64', '16/48', '64/48', '48/16'],
      'correctIndex': 0,
    },
  ];
