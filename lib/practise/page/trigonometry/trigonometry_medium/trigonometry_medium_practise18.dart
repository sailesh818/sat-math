...
class TrigonometryMediumPractise18 extends StatefulWidget {
  ...
  @override
  State<TrigonometryMediumPractise18> createState() => _TrigonometryMediumPractise18State();
}

class _TrigonometryMediumPractise18State extends State<TrigonometryMediumPractise18> {
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            const Text(
              'Topic: SAT Math – Trigonometric Ratios and Right Triangle Properties',
              style: TextStyle(
                  fontSize: 18,
