...
class TrigonometryMediumPractise13 extends StatefulWidget {
  ...
  @override
  State<TrigonometryMediumPractise13> createState() => _TrigonometryMediumPractise13State();
}

class _TrigonometryMediumPractise13State extends State<TrigonometryMediumPractise13> {
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            const Text(
              'Topic: SAT Math – Trigonometric Ratios in Right Triangles',
              style: TextStyle(
                  fontSize: 18,
            ...
            const Text(
              'Practice medium-level problems on trigonometric ratios in right triangles, including sin, cos, and tan.',
