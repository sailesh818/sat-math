...
class TrigonometryMediumPractise6 extends StatefulWidget {
  ...
  @override
  State<TrigonometryMediumPractise6> createState() => _TrigonometryMediumPractise6State();
}

class _TrigonometryMediumPractise6State extends State<TrigonometryMediumPractise6> {
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            const Text(
              'Topic: SAT Math – Right Triangle Trigonometry & Combined Angle Expressions',
              style: TextStyle(
                  fontSize: 18,
