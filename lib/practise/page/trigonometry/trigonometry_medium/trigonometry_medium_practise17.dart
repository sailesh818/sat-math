...
class TrigonometryMediumPractise17 extends StatefulWidget {
  ...
  @override
  State<TrigonometryMediumPractise17> createState() =>
      _TrigonometryMediumPractise17State();
}

class _TrigonometryMediumPractise17State
    extends State<TrigonometryMediumPractise17> {
  ...
  final List<Map<String, dynamic>> questions = [
    {
      'question':
          '1. In a right triangle, opposite = 7 and hypotenuse = 25. Find cos θ.',
      'options': ['24/25', '7/25', '25/7', '7/24'],
      'correctIndex': 0,
      'hint': 'cos θ = adjacent / hypotenuse',
      'explanation': 'Adjacent = √(25² - 7²) = 24 → cos θ = 24/25'
    },
    {
      ...
      'explanation': 'Hypotenuse = √(7² + 24²) = 25 → sin θ = 7/25'
    },
    {
      'question': '3. Find the exact value of sin 90° × cos 0°.',
      'options': ['1/4', '1', '1/2', '1/3'],
      'correctIndex': 1,
      'hint': 'sin 90° = 1, cos 0° = 1',
      'explanation': 'sin 90° × cos 0° = 1 × 1 = 1'
    },
    {
      'question':
          '4. A triangle has sides 15, 36, 39. What is sin θ opposite the side of length 15?',
      'options': ['15/39', '36/39', '39/15', '15/36'],
      'correctIndex': 0,
      'hint': 'sin θ = opposite / hypotenuse',
      'explanation': 'Opposite = 15, hypotenuse = 39 → sin θ = 15/39'
    },
    {
