...
class TrigonometryMediumPractise20 extends StatefulWidget {
  ...
  @override
  State<TrigonometryMediumPractise20> createState() => _TrigonometryMediumPractise20State();
}

class _TrigonometryMediumPractise20State extends State<TrigonometryMediumPractise20> {
  final List<Map<String, dynamic>> _questions = [
    {
      'question': '1. In a right triangle, opposite = 5 and hypotenuse = 13. Find cos θ.',
