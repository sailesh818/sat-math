...
class TrigonometryMediumPractise11 extends StatefulWidget {
  ...
  @override
  State<TrigonometryMediumPractise11> createState() => _TrigonometryMediumPractise11State();
}

class _TrigonometryMediumPractise11State extends State<TrigonometryMediumPractise11> {
  final List<Map<String, dynamic>> _questions = [
    {
      'question': '1. In a right triangle, opposite = 27 and hypotenuse = 45. Find cos θ.',
    ...
    {
      'question': '4. A triangle has sides 9, 40, 41. What is sin θ opposite the side of length 9?',
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            const Text(
              'Topic: SAT Math – Advanced Trigonometric Ratios & Exact Values',
              style: TextStyle(
                  fontSize: 18,
            ...
            const Text(
              'Practice advanced trigonometric problems including right triangle ratios, sin, cos, and tan calculations for higher complexity.',
