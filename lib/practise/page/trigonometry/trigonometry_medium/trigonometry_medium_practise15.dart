...
class TrigonometryMediumPractise15 extends StatefulWidget {
  ...
  @override
  State<TrigonometryMediumPractise15> createState() => _TrigonometryMediumPractise15State();
}

class _TrigonometryMediumPractise15State extends State<TrigonometryMediumPractise15> {
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            const Text(
              'Topic: SAT Math – Trigonometric Ratios and Applications',
              style: TextStyle(
                  fontSize: 18,
            ...
            const Text(
              'Practice medium-level problems on trigonometric ratios, including right triangle ratios, and solving for sin, cos, and tan.',
