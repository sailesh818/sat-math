...
class TrigonometryEasyPractise7 extends StatefulWidget {
  ...
  @override
  State<TrigonometryEasyPractise7> createState() => _TrigonometryEasyPractise7State();
}
...
class _TrigonometryEasyPractise7State extends State<TrigonometryEasyPractise7> {
  final List<Map<String, dynamic>> _questions = [
    ...
    {
      'question': '2. If tan θ = 0, what can θ be?',
      'options': ['45°', '90°', '0°', '30°'],
      'correctIndex': 2,
    },
    {
    ...
    {
      'question': '4. In a right triangle, if opposite = 3 and adjacent = 3, what is tan θ?',
      'options': ['0', '1', '3', '1/3'],
      'correctIndex': 1,
    },
    {
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            const Text(
              'Topic: Basic Trigonometric Ratios & Angles',
              style: TextStyle(
                  fontSize: 18,
            ...
            const Text(
              'Review fundamental trig values frequently tested on SAT math.',
