...
class TrigonometryEasyPractise17 extends StatefulWidget {
  ...
  @override
  State<TrigonometryEasyPractise17> createState() => _TrigonometryEasyPractise17State();
}

class _TrigonometryEasyPractise17State extends State<TrigonometryEasyPractise17> {
  final List<Map<String, dynamic>> _questions = [
    ...
    {
      'question': '2. In a right triangle, opposite = 8 and adjacent = 15. What is tan θ?',
