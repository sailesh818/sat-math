...
class TrigonometryEasyPractise10 extends StatefulWidget {
  ...
  @override
  State<TrigonometryEasyPractise10> createState() => _TrigonometryEasyPractise10State();
}

class _TrigonometryEasyPractise10State extends State<TrigonometryEasyPractise10> {
  final List<Map<String, dynamic>> _questions = [
    ...
    {
      'question': '4. In a right triangle, opposite = 8 and hypotenuse = 10. What is sin θ?',
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            const Text(
              'Topic: Right Triangle & Special Angle Ratios',
              style: TextStyle(
                  fontSize: 18,
            ...
            const Text(
              'Strengthen your SAT Math basics with common trigonometric angles and right triangle ratios.',
