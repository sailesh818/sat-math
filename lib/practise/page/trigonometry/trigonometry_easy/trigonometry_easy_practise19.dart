...
class TrigonometryEasyPractise19 extends StatefulWidget {
  ...
  @override
  State<TrigonometryEasyPractise19> createState() => _TrigonometryEasyPractise19State();
}

class _TrigonometryEasyPractise19State extends State<TrigonometryEasyPractise19> {
  final List<Map<String, dynamic>> _questions = [
    ...
    {
      'question': '2. In a right triangle, opposite = 6 and adjacent = 8. What is tan θ?',
    ...
    {
      'question': '4. If cos θ = √3/2, what is θ in degrees?',
      'options': ['30°', '45°', '60°', '90°'],
      'correctIndex': 2,
    },
    {
      'question': '5. In a right triangle, adjacent = 12 and hypotenuse = 13. What is cos θ?',
