...
class TrigonometryEasyPractise12 extends StatefulWidget {
  ...
  @override
  State<TrigonometryEasyPractise12> createState() => _TrigonometryEasyPractise12State();
}

class _TrigonometryEasyPractise12State extends State<TrigonometryEasyPractise12> {
  final List<Map<String, dynamic>> _questions = [
    ...
    {
      'question': '2. In a right triangle, opposite = 5 and adjacent = 12. What is tan θ?',
    ...
    {
      'question': '4. If tan θ = 1/√3, what is θ in degrees?',
      'options': ['30°', '45°', '60°', '90°'],
      'correctIndex': 0,
    },
    {
      'question': '5. In a right triangle, adjacent = 9 and hypotenuse = 15. What is cos θ?',
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            const Text(
              'Topic: Basic Trigonometric Ratios & Special Angles',
              style: TextStyle(
                  fontSize: 18,
            ...
            const Text(
              'Practice evaluating fundamental trigonometric ratios and angles commonly tested on SAT math.',
