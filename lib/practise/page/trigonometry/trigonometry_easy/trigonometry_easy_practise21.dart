...
class TrigonometryEasyPractise21 extends StatefulWidget {
  ...
  @override
  State<TrigonometryEasyPractise21> createState() => _TrigonometryEasyPractise21State();
}

class _TrigonometryEasyPractise21State extends State<TrigonometryEasyPractise21> {
  final List<Map<String, dynamic>> _questions = [
    ...
    {
      'question': '2. In a right triangle, opposite = 10 and adjacent = 24. What is tan θ?',
