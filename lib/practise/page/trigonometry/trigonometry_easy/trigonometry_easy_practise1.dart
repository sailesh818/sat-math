...
class TrigonometryEasyPractise1 extends StatefulWidget {
  ...
  @override
  State<TrigonometryEasyPractise1> createState() => _TrigonometryEasyPractise1State();
}

class _TrigonometryEasyPractise1State extends State<TrigonometryEasyPractise1> {
  final List<Map<String, dynamic>> _questions = [
    ...
    {
      'question': '4. In a right triangle, if the opposite = 5 and hypotenuse = 13, what is sin(θ)?',
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            const Text(
              'Topic: Basic Trigonometric Ratios & Angle Values',
              style: TextStyle(
                  fontSize: 18,
            ...
            const Text(
              'Practise simple sine, cosine, and tangent values commonly used in SAT problems.',
