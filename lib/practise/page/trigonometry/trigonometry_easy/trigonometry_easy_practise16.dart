...
class TrigonometryEasyPractise16 extends StatefulWidget {
  ...
  @override
  State<TrigonometryEasyPractise16> createState() => _TrigonometryEasyPractise16State();
}

class _TrigonometryEasyPractise16State extends State<TrigonometryEasyPractise16> {
  final List<Map<String, dynamic>> _questions = [
    ...
    {
      'question': '2. In a right triangle, opposite = 7 and adjacent = 24. What is tan θ?',
    ...
    {
      'question': '5. In a right triangle, adjacent = 20 and hypotenuse = 29. What is cos θ?',
      'options': ['20/29', '21/29', '√3/2', '3/5'],
      'correctIndex': 0,
    },
  ];
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text(
              'Practice basic trigonometric ratios and right triangle angles commonly tested on SAT Math.',
