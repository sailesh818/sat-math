...
class TrigonometryEasyPractisePage extends StatefulWidget {
  final String jsonFileName;
  final String title;

  const TrigonometryEasyPractisePage({
    super.key,
  ...
  @override
  State<TrigonometryEasyPractisePage> createState() =>
      _TrigonometryEasyPractisePageState();
}

class _TrigonometryEasyPractisePageState
    extends State<TrigonometryEasyPractisePage> {
  ...
  Future<void> loadQuestions() async {
    try {
      final String response = await rootBundle.loadString(
          'assets/trigonometry/trigonometryeasy/${widget.jsonFileName}');
