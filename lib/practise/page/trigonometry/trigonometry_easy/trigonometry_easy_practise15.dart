...
class TrigonometryEasyPractise15 extends StatefulWidget {
  ...
  @override
  State<TrigonometryEasyPractise15> createState() => _TrigonometryEasyPractise15State();
}

class _TrigonometryEasyPractise15State extends State<TrigonometryEasyPractise15> {
  final List<Map<String, dynamic>> _questions = [
    ...
    {
      'question': '5. In a right triangle, adjacent = 15 and hypotenuse = 17. What is cos θ?',
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text(
              'Practice evaluating basic trigonometric ratios and common SAT angles in right triangles.',
